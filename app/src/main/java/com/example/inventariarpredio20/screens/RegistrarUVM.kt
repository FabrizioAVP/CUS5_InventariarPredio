...
@Composable
fun RegistrarUVM(navController: NavController){
    Scaffold (
        topBar = {
        ...
        ContenidoRegistrarUVM(navController)
    }
}

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun ContenidoRegistrarUVM(navController: NavController){
    ...
    Box(modifier = Modifier.padding(start = 16.dp, top = 76.dp, end = 16.dp, bottom = 16.dp)){
        Column(
            ...
            Text("Registrar Unidad de Vivienda Múltiple",
                color = Color.White,
                fontSize = 18.sp,
                modifier = Modifier
                    .fillMaxWidth()
            ...
            Card(
                ...
                Image(
                    painter = painterResource(id = R.drawable.unidadvm), // Reemplaza "nombre_de_la_imagen" con el nombre de tu imagen en recursos
            ...
            FiltroSeleccionPredio()

            Spacer(modifier = Modifier.height(5.dp))

            Text("Tipo de Unidad de Vivienda Múltiple",
                color = Color.White,
                fontSize = 15.sp,
                modifier = Modifier
                    .fillMaxWidth()
