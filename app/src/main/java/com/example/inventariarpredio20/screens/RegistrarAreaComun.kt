            ...
            Row {
                ...
                Button(onClick = {
                    ...
                    if (textValue3.isEmpty() || textValue4.isEmpty()) {
                        ...
                        GlobalScope.launch {
                            var idPredio = obtenerIdPredioSeleccionado(nombrePredioSeleccionado) ?: 0
...
//@OptIn(ExperimentalMaterial3Api::class)
//@Composable
 suspend fun obtenerIdPredioSeleccionado(nombrePredio: String): Int? {
